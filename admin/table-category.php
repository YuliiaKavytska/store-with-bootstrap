<?php
	...
	<tr>
		...
		<div class="btn-group mr-2" role="group" aria-label="First group">
			...
			<div data-link="http://store.local/admin/options/category/delete.php?id=<?php echo $row["id"] ?>" onclick="deleteProduct(this)" id="delete-categ-btn" class="btn btn-danger">Delete</div>
		</div>
		</td>
		</tr>
	<?php
